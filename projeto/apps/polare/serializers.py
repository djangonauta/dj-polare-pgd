...
class PlanoIndividualSerializer(serializers.ModelSerializer):
    ...
    cpf = serializers.CharField(source='char', default='00000000000')
    ...
    carga_horaria_semanal = serializers.IntegerField()
    ...
    horas_homologadas = serializers.IntegerField(source='carga_horaria_semanal')
